...
const Hero = () => (
  <section id="hero" className="h-screen flex flex-col justify-center items-center text-white bg-gradient-to-br from-slate-900 to-gray-800 text-center px-6">
    ...
    <a href="#projects" className="px-6 py-2 bg-indigo-500 hover:bg-indigo-600 rounded-md shadow text-white mb-5">View Projects</a>
        <a href="#experience" className="px-6 py-2 bg-indigo-500 hover:bg-indigo-600 rounded-md shadow text-white mb-5">Experience</a>
    <a href="#contact" className="px-6 py-2 bg-indigo-500 hover:bg-indigo-600 rounded-md shadow text-white">Contact Me</a>
  </section>
);
